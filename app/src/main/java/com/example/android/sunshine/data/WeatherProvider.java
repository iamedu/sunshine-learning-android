...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String s, String[] strings) {
        ...
        switch(match) {
            case LOCATION:
                rowNum = db.delete(WeatherContract.LocationEntry.TABLE_NAME, s, strings);
                break;
            case WEATHER:
                rowNum = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, s, strings);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(Uri uri, ContentValues contentValues, String s, String[] strings) {
        ...
        switch(match) {
            case LOCATION:
                rowNum = db.update(WeatherContract.LocationEntry.TABLE_NAME, contentValues, s, strings);
                break;
            case WEATHER:
                rowNum = db.update(WeatherContract.WeatherEntry.TABLE_NAME, contentValues, s, strings);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
